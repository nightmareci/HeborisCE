...
@cmake "%SOURCE_DIRECTORY%" -B "%BUILD_DIRECTORY%\x64\build" -DPACKAGE_TYPE=Portable -DHIDE_WINDOWS_CONSOLE=1 -DUSE_VENDOR_LIBRARIES=1 -DSDL_LIBC=1 -A x64 -DCMAKE_INSTALL_PREFIX="%BUILD_DIRECTORY%\x64\%NAME%"
...
@cmake "%SOURCE_DIRECTORY%" -B "%BUILD_DIRECTORY%\x86\build" -DPACKAGE_TYPE=Portable -DHIDE_WINDOWS_CONSOLE=1 -DUSE_VENDOR_LIBRARIES=1 -DSDL_LIBC=1 -A Win32 -DCMAKE_INSTALL_PREFIX="%BUILD_DIRECTORY%\x86\%NAME%"
@if %ERRORLEVEL% NEQ 0 goto error
...
@cmake "%SOURCE_DIRECTORY%" -B "%BUILD_DIRECTORY%\ARM64\build" -DPACKAGE_TYPE=Portable -DHIDE_WINDOWS_CONSOLE=1 -DUSE_VENDOR_LIBRARIES=1 -DSDL_LIBC=1 -A ARM64 -DCMAKE_INSTALL_PREFIX="%BUILD_DIRECTORY%\ARM64\%NAME%"
@if %ERRORLEVEL% NEQ 0 goto error
