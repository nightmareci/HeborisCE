...
typedef int (* APP_PutBDFPixelCallback)(void* dst, int x, int y, float subx, float suby, SDL_Color color);
...
int APP_PutBDFTextSurface(APP_BDFFont* font, int dx, int dy, float subx, float suby, SDL_Surface* dst, const char* text, SDL_Color fg);
int APP_PutBDFTextRenderer(APP_BDFFont* font, int dx, int dy, float subx, float suby, SDL_Renderer* dst, const char* text, SDL_Color fg);
