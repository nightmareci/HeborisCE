...
// void APP_ReadFile32(const char* filename, int32_t* values, size_t start, size_t count);
// void APP_WriteFile32(const char* filename, int32_t* values, size_t start, size_t count);
