...
void RankingRegist(int rmode, int rtt, int rsc, int rli, int rlv, int rtime, int end, const char *rname);
...
void RankingRegist2(int rmode, int rrots, int rdata, int rtime, int rclear, int rother, const char *rname, int rank, int rac, int rst, int rsk, int rco ,int rre);
...
void RankingRegist3(int rmode, int rex,int rrots, int rdata, int rtime, int rclear, int rother, const char *rname, int rank, int rac, int rst, int rsk, int rco ,int rre);
