...
int	wait1_devil_roll = 5;		// 固定→次
int	wait2_devil_roll = 3;		// ブロック消去
int	wait3_devil_roll = 13;		// 接地→固定
int	waitt_devil_roll = 7;		// 横溜め

// 遅延防止モード用
int	speed_limit15 = 1200;		// 落下速度(1200 = 20G)
int	wait1_limit15 = 5;			// 固定→次
int	wait2_limit15 = 0;			// ブロック消去
int	wait3_limit15 = 13;			// 接地→固定
...
int	wait1_tomoyo = 26;		// 固定→次
int	wait2_tomoyo = 40;		// ブロック消去
int	wait3_tomoyo = 28;		// 接地→固定
int	waitt_tomoyo = 15;		// 横溜め
