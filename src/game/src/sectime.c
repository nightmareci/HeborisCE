...
void ST_RankingSave(void) {//12345 6789
	...
	FILESYSTEM_WriteFile32("config/data/STRANKING.SAV", saveBuf, 400);
}
...
int32_t ST_RankingLoad(void) {
	...
	// バージョンを見る
	FILESYSTEM_ReadFile32("config/data/STRANKING.SAV", saveBuf, 1, 0);
	...
	// 全体を読み込む
	FILESYSTEM_ReadFile32("config/data/STRANKING.SAV", saveBuf, 400, 0);
...
void PlayerdataSave(void) {//12345 6789
	...
	FILESYSTEM_WriteFile32("config/data/PLAYERDATA.SAV", saveBuf, 100);
}
...
int32_t PlayerdataLoad(void) {
	...
	// バージョンを見る
	FILESYSTEM_ReadFile32("config/data/PLAYERDATA.SAV", saveBuf, 1, 0);
	...
	// 全体を読み込む
	FILESYSTEM_ReadFile32("config/data/PLAYERDATA.SAV", saveBuf, 100, 0);
